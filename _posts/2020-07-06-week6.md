...
Using a magnifying glass poly from Google Poly and the `Entity` component, I added it to Simr. Approached some bugs, will ask for help from Professor Anderson. 
