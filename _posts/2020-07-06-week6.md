...
**Thoughts**
- I am creating the `getVariables` function, so that when code is inputted into the `mainExample`, the variables will be automatically collected and displayed in `varPanel`. Though this is not a step, I think it is a good feature to add. 
